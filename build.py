...
<head>
  ...
  <meta http-equiv="Content-Security-Policy" content="default-src 'self'; img-src 'self' data:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; script-src 'self'; connect-src 'self'; frame-src https://www.google.com https://maps.google.com; base-uri 'self'; form-action 'self'" />
      ...
      <div class="container">
        <div class="split" style="align-items:start">
          <div class="contato-info">
            <span class="olho">Canais diretos</span>
            <h2 class="secao-titulo">Fale com a gente</h2>
            <p class="secao-intro">Escolha o canal que preferir. Respondemos pelo e-mail e
            ...
            <div class="info-item">
              ...
              <div><strong>Instagram</strong><br />
                ...
                · <a href="https://instagram.com/ciapedepano_oficial" target="_blank" rel="noopener">@ciapedepano_oficial</a></div>
            </div>
            <div class="info-item">
              <span class="icone" aria-hidden="true">▶️</span>
              <div><strong>YouTube</strong><br />
                <a href="https://www.youtube.com/@ciapedepano_matozinhos1996" target="_blank" rel="noopener">Cia Pé de Pano</a></div>
            </div>
            <div class="info-item">
              <span class="icone" aria-hidden="true">📍</span>
            ...
            <div class="contato-ctas">
              <a class="btn btn-terra" href="mailto:quintaldaspretas2015@gmail.com?subject=Contato%20pelo%20site%20Quintal%20das%20Pretas">Enviar e-mail</a>
              <a class="btn btn-verde" href="https://instagram.com/quintaldaspretas" target="_blank" rel="noopener">Falar no Instagram</a>
            </div>
          </div>
